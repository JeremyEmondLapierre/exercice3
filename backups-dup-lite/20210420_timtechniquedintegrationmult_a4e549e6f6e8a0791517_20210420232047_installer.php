...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210420_timtechniquedintegrationmult_a4e549e6f6e8a0791517_20210420232047_archive.zip';
	const ARCHIVE_SIZE		 = '64824384';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'a4e549e-20232047';
    const SECONDARY_PACKAGE_HASH = '8f20314-20232047';
	const VERSION			 = '1.4.0';
